...
const PasswordResetFlow = () => {
  ...
  const handleRequestOTP = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("/api/v1/restaurant/requestOTP", {
        email,
      });
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("/api/v1/restaurant/verifyOTP", {
        email,
        otp,
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post("/api/v1/restaurant/resetPassword", {
        email,
        otp,
        newPassword,
      });
          ...
          <form className="mt-8 space-y-6" onSubmit={handleVerifyOTP}>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-400 hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 ${
                  loading ? "opacity-70 cursor-not-allowed" : ""
                }`}
              >
                {loading ? (
