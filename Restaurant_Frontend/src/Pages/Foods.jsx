...
function Foods() {
  ...
  return (
    ...
    //     {(isLoading || contextLoading) && !data.length && (
    ...
    //     {data.length === 0 && !isLoading && !contextLoading && !error && (
    //       <div className="mt-8 text-center text-gray-600">
    //         No food items available. Add some to get started!
    //       </div>
    //     )}
    ...
    //           {Array.isArray(foodPopup.ingredients)
    //             ? foodPopup.ingredients.join(", ")
    //             : foodPopup.ingredients || ""}
    //         </p>
    //         <button
    //           className="bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded w-full"
    //           onClick={() => setFoodPopup(null)}
    ...
    //         <div className="flex justify-around mt-4">
    //           <button
    //             className="bg-orange-400 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded disabled:opacity-50"
    //             onClick={() => {
    //               modal.action();
    //             }}
    //             disabled={isLoading}
