    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        <button
          ...
          className="px-8 py-3 bg-orange-400 text-white rounded-lg hover:bg-orange-500 transition-all duration-300"
        >
          Return to Cart
        </button>
      </div>
              ...
              <div className="relative">
                ...
                {(!user?.address || user.address.length === 0) && (
                  <button
                    ...
                    className="absolute right-0 top-1/2 transform -translate-y-1/2 text-orange-400 hover:text-orange-500 text-sm font-medium"
                  >
                    + Add Address
                  </button>
                )}
              ...
              <div className="flex flex-col space-y-3">
                <label className="flex items-center p-3 border border-gray-200 rounded-md cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    className="mr-3 text-orange-400 focus:ring-orange-400"
                  />
                  <div>
              ...
              <div className="space-y-3 text-gray-600">
                {order.orderItems.map((item) => (
                  ...
                  >
                    ...
                    <span className="text-orange-400">₹{item.totalPrice}</span>
                  </div>
                ))}
              </div>
