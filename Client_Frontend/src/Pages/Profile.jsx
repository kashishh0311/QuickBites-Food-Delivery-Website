...
//     setPasswordFormData({
//       ...passwordFormData,
//       [e.target.name]: e.target.value, // Removed trim()
//     });
//   };
...
//       // Update previewImage with the new profileImage URL
...
//                             <button
//                               className="bg-orange-400 hover:bg-orange-500 text-white px-4 py-1 rounded-full text-sm transition-colors"
//                               onClick={() => trackOrder(order._id)} // Fixed binding
//                             >
//                               Track Order
//                             </button>
//                           </div>
...
//                     </p>
//                     <button
//                       onClick={() => navigate("/")} // Added navigation
